            ...
            <div>
                <asp:ListView ID="ListView4" runat="server" DataKeyNames="MaKH" DataSourceID="KhachHang" InsertItemPosition="LastItem">
                    <AlternatingItemTemplate>
                        <td runat="server" style="background-color: #FFFFFF;color: #284775;padding-left:20px;padding-right:20px;">MaKH:
                    ...
                    <ItemTemplate>
                        <td runat="server" style="background-color: #E0FFFF;color: #333333; padding-left:20px;padding-right:20px;">MaKH:
                            <asp:Label ID="MaKHLabel" runat="server" Text='<%# Eval("MaKH") %>' />
                            <br />
                            TenKH:
                            <asp:Label ID="TenKHLabel" runat="server" Text='<%# Eval("TenKH") %>' />
